...
# <RdIcon name="boxes" /> Analyse SOC : Découverte d'ElasticStack
<ESDInfo />

## <RdIcon name="layers" /> 3 en un
...
## <RdIcon name="brand-elasticsearch" /> Elasticsearch
...
## <RdIcon name="file-code" /> Logstash
...
## <RdIcon name="brand-kibana" /> Kibana
...
## <RdIcon name="cog" /> Processus de fonctionnement
