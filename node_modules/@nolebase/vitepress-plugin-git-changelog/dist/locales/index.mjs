var data$4 = { changelog:{ title:"Changelog",
    titleId:"changelog",
...
var data$2 = { changelog:{ title:"История изменений",
...
export { data$5 as defaultEnLocale, data$3 as defaultRuLocale, data$1 as defaultZhCNLocale };
